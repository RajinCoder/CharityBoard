...
const Navbar = () => {
  return (
    <nav className="bg-blue-500 px-4 py-1 flex items-center justify-between">
      {/* CharityConnect Text */}
      ...
      <div className="flex items-center border-2 border-blue-500 bg-white rounded-md ml-4 flex-grow">
        ...
        {/* Pin Icon Button */}
        <button className="p-2">
          <img src="https://cdn-icons-png.freepik.com/512/7310/7310018.png" alt="Location" className="w-6 h-6" /> {/* Adjusted size */}
        </button>
      </div>
      ...
      <div>
        ...
        <button className="text-white mx-2 ring-1 ring-white rounded-md px-3 py-1 hover:bg-white hover:text-blue-500 transition-colors">Saved</button>
